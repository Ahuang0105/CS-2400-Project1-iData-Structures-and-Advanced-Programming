...
public class ArrayTest {
	...
	public static void main(String[] args) {
		...
		BagInterface<String> bookPiles = new PileOfBooks<String>();
				
		System.out.println("*************************************************************************************************************\n");
		
		System.out.println("The pile can only store 5 books. \n\n");
		
		System.out.println("We will add 6 books to the pile to see if the program will increase the pile size. \n\n");
		...
		System.out.println("We successful adding 6 books to the pile so the pile size has been increase. \n\n");
